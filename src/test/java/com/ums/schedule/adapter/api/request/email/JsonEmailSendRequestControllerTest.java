...
class JsonEmailSendRequestControllerTest {
    ...
    @Nested
    @DisplayName("발송 요청 : JSON")
    class WhenSendRequestWithFileUpload {
        private final String URL = "/api/v1/send-requests/email";
