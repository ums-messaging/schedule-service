...
class JobCreatedEventTest {
    @Test
    @DisplayName("SendRequestStatus가 HOLDING이면 HOLDING을 반환한다.")
    void shouldReturnSendRequestStatusIsHolding_whenSendRequestStatusIsHolding() {

    }

    @Test
    @DisplayName("SendRequestStatus가 HOLDING이면, SendRequestEvent의 타입은 JOB_CREATED를 반환한다.")
    void shouldReturnSendRequestEventTypeIsJobCreated_whenSendRequestStatusIsHolding() {
