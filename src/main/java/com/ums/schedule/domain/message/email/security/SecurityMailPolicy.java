package com.ums.schedule.domain.message.email.security;
...
public class SecurityMailPolicy {
    ...
    public String getTargetPassword(Map<String, Object> targetData) {
        String password = String.valueOf(targetData.get(this.passwordPolicy));
        return password;
    }
