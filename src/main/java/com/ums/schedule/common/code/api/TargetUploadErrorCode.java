...
public enum TargetUploadErrorCode implements ErrorCode {
    ...
    TARGET_UPLOAD_FILESIZE_LIMIT_EXCEEDED(ApiResponseCode.BAD_REQUEST, "업로드 파일 크기가 허용 범위를 초과했습니다. (최대 허용 : {0}, 파일 크기 : {1})"),
    ...
    FILE_IS_EMPTY(ApiResponseCode.BAD_REQUEST, "비어있는 내용의 파일입니다."),
