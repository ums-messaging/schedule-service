...
public class QEmailSendMessage extends EntityPathBase<EmailSendMessage> {
    ...
    private static final long serialVersionUID = 1450781212L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEmailSendMessage emailSendMessage = new QEmailSendMessage("emailSendMessage");

    public final ListPath<com.ums.schedule.domain.message.email.EmailAttachment, com.ums.schedule.domain.message.email.QEmailAttachment> attachmentList = this.<com.ums.schedule.domain.message.email.EmailAttachment, com.ums.schedule.domain.message.email.QEmailAttachment>createList("attachmentList", com.ums.schedule.domain.message.email.EmailAttachment.class, com.ums.schedule.domain.message.email.QEmailAttachment.class, PathInits.DIRECT2);
