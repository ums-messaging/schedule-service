...
public class QEmailSendMessage extends EntityPathBase<EmailSendMessage> {
    ...
    private static final long serialVersionUID = 905980854L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEmailSendMessage emailSendMessage = new QEmailSendMessage("emailSendMessage");

    public final ListPath<EmailAttachment, com.ums.schedule.domain.request.resource.email.QEmailAttachment> attachmentList = this.<EmailAttachment, com.ums.schedule.domain.request.resource.email.QEmailAttachment>createList("attachmentList", EmailAttachment.class, com.ums.schedule.domain.request.resource.email.QEmailAttachment.class, PathInits.DIRECT2);
    ...
    public final com.ums.schedule.domain.request.message.QSendMessage sendMessage;
    ...
    public QEmailSendMessage(Class<? extends EmailSendMessage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.sendMessage = inits.isInitialized("sendMessage") ? new com.ums.schedule.domain.request.message.QSendMessage(forProperty("sendMessage"), inits.get("sendMessage")) : null;
    }
