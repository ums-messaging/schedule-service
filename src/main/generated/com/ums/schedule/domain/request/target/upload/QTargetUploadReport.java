...
public class QTargetUploadReport extends EntityPathBase<TargetUploadReport> {
    ...
    public final SimplePath<com.ums.schedule.domain.request.target.upload.state.TargetUploadState> state = createSimple("state", com.ums.schedule.domain.request.target.upload.state.TargetUploadState.class);
