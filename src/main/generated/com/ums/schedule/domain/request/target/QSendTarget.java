...
public class QSendTarget extends EntityPathBase<SendTarget> {
    ...
    public final SimplePath<com.ums.schedule.domain.request.target.state.SendTargetState> state = createSimple("state", com.ums.schedule.domain.request.target.state.SendTargetState.class);

    public final StringPath targetKey = createString("targetKey");

    public final StringPath targetName = createString("targetName");

    public final com.ums.schedule.domain.request.target.upload.QTargetUploadReport targetUpload;
    ...
    public QSendTarget(Class<? extends SendTarget> type, PathMetadata metadata, PathInits inits) {
        ...
        this.targetUpload = inits.isInitialized("targetUpload") ? new com.ums.schedule.domain.request.target.upload.QTargetUploadReport(forProperty("targetUpload"), inits.get("targetUpload")) : null;
    }
