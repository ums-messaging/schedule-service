package com.ums.schedule.domain.request.resource.email;
...
public class QEmailAttachment extends EntityPathBase<EmailAttachment> {
    ...
    private static final long serialVersionUID = -2139802329L;
    ...
    public final com.ums.schedule.domain.request.resource.email.policy.QSecurityMailPolicy securityPolicy;

    public final com.ums.schedule.domain.request.message.email.QEmailSendMessage sendMessage;
    ...
    public QEmailAttachment(Class<? extends EmailAttachment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.securityPolicy = inits.isInitialized("securityPolicy") ? new com.ums.schedule.domain.request.resource.email.policy.QSecurityMailPolicy(forProperty("securityPolicy")) : null;
        this.sendMessage = inits.isInitialized("sendMessage") ? new com.ums.schedule.domain.request.message.email.QEmailSendMessage(forProperty("sendMessage"), inits.get("sendMessage")) : null;
    }
