...
public class QTargetUploadReport extends EntityPathBase<TargetUploadReport> {
    ...
    private static final long serialVersionUID = 175905897L;
    ...
    public final SimplePath<com.ums.schedule.domain.target.upload.state.TargetUploadState> state = createSimple("state", com.ums.schedule.domain.target.upload.state.TargetUploadState.class);
    ...
    public final EnumPath<com.ums.schedule.common.code.target_upload.TargetUploadType> uploadType = createEnum("uploadType", com.ums.schedule.common.code.target_upload.TargetUploadType.class);
