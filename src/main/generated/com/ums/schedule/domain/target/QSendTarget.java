...
public class QSendTarget extends EntityPathBase<SendTarget> {
    ...
    private static final long serialVersionUID = -433431133L;
    ...
    public final EnumPath<SendTargetStatusEnum> status = createEnum("status", SendTargetStatusEnum.class);

    public final StringPath targetKey = createString("targetKey");

    public final StringPath targetName = createString("targetName");

    public final com.ums.schedule.domain.sendrequest.upload.QTargetUploadReport targetUpload;
    ...
    public QSendTarget(Class<? extends SendTarget> type, PathMetadata metadata, PathInits inits) {
        ...
        this.targetUpload = inits.isInitialized("targetUpload") ? new com.ums.schedule.domain.sendrequest.upload.QTargetUploadReport(forProperty("targetUpload"), inits.get("targetUpload")) : null;
    }
